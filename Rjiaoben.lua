...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "R脚本",Text = "欢迎使用",Icon = "rbxassetid://138406365430405",Duration = 3,Callback = bindable,Button1 = "天天开心",Button2 = "天天快乐"})

game:GetService("StarterGui"):SetCore("SendNotification",{Title = "R脚本",Text = "要加什么服务器",Icon = "rbxassetid://138406365430405",Duration = 5,Callback = bindable,Button1 = "脚本信息",Button2 = "加我QQ"})
...
local about = UITab1:section("『R脚本』",false)

about:Label("R脚本")
about:Label("作者QQ：3529399795")
about:Label("QQ群：902972095")
about:Label("作者：R")
about:Label("进群发最新R脚本")
about:Label("脚本持续更新中")
about:Label("脚本正在优化")
about:Label("欢迎使用")
about:Label("你好"..game.Players.LocalPlayer.UserId)

local UITab4 = win:Tab("『加入服务器』",'16060333448')

local about = UITab4:section("『R脚本』",true)
...
local about = UITab5:section("『R脚本』",true)

    about:Button("点我复制R脚本交流群群",function()
...
about:Button("传送到玩家旁边", function()
    ...
    if tp_player and tp_player.Character and tp_player.Character.HumanoidRootPart then
        ...
        Notify("R", "已经传送到玩家身边", "rbxassetid://", 5)
    else
        Notify("R", "无法传送 玩家已消失", "rbxassetid://", 5)
    end
end)
...
about:Toggle("查看玩家", 'Toggleflag', false, function(state)
    if state then
        game:GetService('Workspace').CurrentCamera.CameraSubject =
            ...
            Notify("R", "已开启", "rbxassetid://", 5)
    else
        Notify("R", "已关闭", "rbxassetid://", 5)
...
local UITab5 = win:Tab("『自瞄』",'16060333448')
...
local about = UITab20:section("『R脚本』",true)
...
about:Toggle("预测灾害","",false,function(val)        
		...
		while wait(5) and nextdis do
			...
			if SurvivalTag then
				if SurvivalTag.Value == "Blizzard" and nextdis then
			        Notify("R脚本", "下一个灾难是暴风雪", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Sandstorm" and nextdis then
			        Notify("R脚本", "下一个灾难是沙尘暴", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Tornado" and nextdis then			
					        Notify("R脚本", "下一个灾难是龙卷风", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Volcanic Eruption" and nextdis then
        Notify("R脚本", "下一个灾难是火山", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Flash Flood" and nextdis then
        Notify("R脚本", "下一个灾难是洪水", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Deadly Virus" and nextdis then
        Notify("R脚本", "下一个灾难是病毒", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Tsunami" and nextdis then
        Notify("R脚本", "下一个灾难是海啸", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Acid Rain" and nextdis then		
					        Notify("R脚本", "下一个灾难是酸雨", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Fire" and nextdis then	
					    Notify("R脚本", "下一个灾难是火焰", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Meteor Shower" and nextdis then
	    Notify("R脚本", "下一个灾难是流星雨", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Earthquake" and nextdis then
	    Notify("R脚本", "下一个灾难是地震", "rbxassetid://", 1)
				elseif SurvivalTag.Value == "Thunder Storm" and nextdis then
        Notify("R脚本", "下一个灾难是雷暴", "rbxassetid://", 1)
        wait(10)        
				else
					Message.Visible = false
...
local UITab26 = win:Tab("『最强战场』",'16060333448')

local about = UITab26:section("『脚本』",true)
